...
class SnatchGame{
  constructor(){
    ...
    this.snatch = [
      ...
      "Snatch Game: Family Editon",
      "Snatch Game Down Under"
    ];
    ...
    {
      case 0:
        this.episodename = "Snatch Game - " + CurrentSeason.seasonname;
        break;
      case 1:
      ...
      case 2:
        ...
        break;
        case 3:
          this.episodename = "The Snatch Summit"
          break;
          case 4:
            this.episodename = "The Supersized Snatch Game"
            break;
            case 5:
              this.episodename = "Snatch Game: Family Editon"
              break;
              case 6:
                this.episodename = "Snatch Game Down Under"
                break;
...
class Ball{
  constructor(){
    ...
    this.balls = [
      ...
      ["The I Can See Your Voice Ball", "Lipsync Showdown Showgirls", "Bad Singer Style", "Celebriy Duet Eleganza"]
    ];
  ...
  class Rusical{
    ...
    TopPlacement()
    {
      ...
      "Your performance in the Rusical was giving award winning eleganza"
      ];
      return(Top[getRandomInt(0,Top.length-1)]);
    }
...
class ImprovChallenge{
  ...
  constructor(){
    ...
    this.plays = [
      ...
      " will have to participate in a roast at the Kennedy Davenport Center Honors Hall Of Shade"
    ];
    ...
    switch(this.chosen)
    {
      ...
      case 7:
        ...
        break;
      case 8:
        this.episodename = "The Kennedy Davenport Center Honors Hall Of Shade"  
    }
...
class DesignChallenge{
  constructor()
  {
    ...
    this.episodename = [
      "Queens Of All Seasons",
      "Royalty Returns",
      "House of Fashion",
      "Watcha Packin?",
      "Bingo She Betta Don't!",
      "Lockdown Supersheros",
      "Campfire Couture",
      "Rupaul's Design Contest",
...
class Makeover{
  constructor()
  {
    ...
    this.brief = [
      ...
      "The queens will have to makeover their relatives"
    ];
...
function GetRandowRunway() {
  ...
  let songsus = [
    ...
    '"Shower" by Becky G',
    '"Maybe Your The Problem" by Ava Max'
  ...
  let songcustom = [
   '"On My Love" by Zara Larrson and David Guetta',
   '"Bed" by Raye',
   '"Heartbreak Anthem" by Little Mix',
   ...
   '"Crazy What Love Can Do" by Becky Hill',
   '"Remember" by Becky Hill',
   '"Sweet Melody" by Little Mix',
   '"This Is Real" by Ella Henderson',
   '"Cant Tame Her" by Zara Larrson',
   '"Snap" by Rosa Linn',
   '"Tattoo" by Loreen',
...
function GetSong(){
  switch(CurrentSeason.country)
  {
    ...
    case "GERMANY":
      ...
      case "CUSTOM":
      let chosencustom = songcustom[getRandomInt(0,songcustom.length-1)];
      songcustom.splice(songcustom.indexOf(chosencustom),1);
      return(chosencustom);
      break;
